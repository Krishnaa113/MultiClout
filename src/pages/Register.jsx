...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('Registration error in component:', error.response?.data);
  ...
  return (
    <div className="min-h-screen bg-white mt-16" style={{ fontFamily: "'Segoe UI', 'Roboto', sans-serif" }}>
        ...
        <div className="max-w-md w-full">
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-center text-sm" style={{ color: '#4a5568' }}>
              Join India's No.1 Business Education Network
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-xl p-8">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div>
                <label htmlFor="name" className="block text-sm font-medium mb-2" style={{ color: '#1e3a5f' }}>
                  Full Name
                </label>
                <input
                  id="name"
                  ...
                  className={`block w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 sm:text-sm transition-colors ${
                    errors.name ? 'border-red-300 focus:ring-red-500' : 'border-gray-300 focus:ring-cyan-500'
                  }`}
              ...
              <div>
                <label htmlFor="username" className="block text-sm font-medium mb-2" style={{ color: '#1e3a5f' }}>
                  Username
                </label>
                <input
                  id="username"
                  ...
                  onChange={handleChange}
                  className={`block w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 sm:text-sm transition-colors ${
                    errors.username ? 'border-red-300 focus:ring-red-500' : 'border-gray-300 focus:ring-cyan-500'
                  }`}
              ...
              <div>
                <label htmlFor="phone" className="block text-sm font-medium mb-2" style={{ color: '#1e3a5f' }}>
                  Phone Number
                </label>
                <input
                  id="phone"
                  ...
                  onChange={handleChange}
                  className={`block w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 sm:text-sm transition-colors ${
                    errors.phone ? 'border-red-300 focus:ring-red-500' : 'border-gray-300 focus:ring-cyan-500'
                  }`}
              ...
              <div>
                <label htmlFor="confirmPassword" className="block text-sm font-medium mb-2" style={{ color: '#1e3a5f' }}>
                  Confirm Password
                </label>
                <input
                  id="confirmPassword"
                  ...
                  onChange={handleChange}
                  className={`block w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 sm:text-sm transition-colors ${
                    errors.confirmPassword ? 'border-red-300 focus:ring-red-500' : 'border-gray-300 focus:ring-cyan-500'
                  }`}
